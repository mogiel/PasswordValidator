"""module for checking lowercase letters"""
# local code
from password_validators.validator import Validator


class PasswordLowercaseCharValidator(Validator):
    ...
    def info(self) -> str:
        ...
        :return: password strength with lowercase letters
        :rtype: int
        """

        if self.is_valid is True:
            return "Check lowercase character: OK"
        return "Check lowercase character: NOT"
